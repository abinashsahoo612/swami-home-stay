        ...
        <div className="row align-item-center">
          <div className="col-xl-6 col-lg-6 lg-mb-30">
            <div className="accommodations__two-title">
              ...
              <p>
                ...
                serene surroundings. We specialize in providing a homely
                atmosphere perfect for families and couples seeking a relaxing
                getaway.
              </p>
              <div className="key-features mt-4">
                ...
                <ul className="feature-list">
                  <li>
                    3 Different AC & Non AC Rooms with Ground Floor Access
                  </li>
                  <li>24-Hour Security with CCTV Surveillance</li>
                  <li> In-house Restaurant with Homemade Food and Breakfast</li>
          ...
          <div className="col-xl-6 col-lg-6 col-md-7">
            <div className="accommodations__two-right">
              <img src="/img/rooms/img4.jpg" alt="Swami Home Stay Exterior" />
            </div>
          </div>
        </div>
      </div>
